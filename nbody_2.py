# -*- coding: utf-8 -*-
"""
Created on Tue Feb 19 23:58:07 2019
...
"""
    ...
    New  run time: --- 128.970000029 seconds ---
    Relative speed up: 1.06X (least improvement) (136.609/128.970)
"""
...
def advance(dt):
    ...
    '''
#    CHANGE: initiate seenit as set instead of list
#    seenit = []
    seenit = set()
...
#                CHANGE: add item to set instead of append to list
#                seenit.append(body1)
                seenit.add(body1)
